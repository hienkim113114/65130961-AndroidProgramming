...
public class LandScape_Adapter extends RecyclerView.Adapter< LandScape_Adapter.ItemLandHolder> {
   Context context;
   ArrayList<LandScape> lstData;

    public LandScape_Adapter(Context context, ArrayList<LandScape> lstData) {
